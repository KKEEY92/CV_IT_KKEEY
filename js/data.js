...
window.KKIT_DATA = {
  ...
  hero: {
    greeting: {
      ...
      pl: 'Interfejs Systemowy · Future Orchestrator',
    },
    name: 'Kevin Kuck',
    roles: {
      de: [
      ...
      pl: [
        'Administrator IT · Administracja Systemami',
        'Identity & Access Management (AD · Entra ID)',
        'Infrastruktura Krytyczna (KRITIS) & Endpoint Governance',
        'PowerShell & Orkiestracja Przepływów Pracy',
        'Enterprise Support & Automatyzacja Procesów',
      ],
    },
    meta: {
    ...
    cta1: { de: 'IT-Portfolio ansehen', en: 'View IT Portfolio', fr: 'Voir le portfolio IT', uk: 'Переглянути IT-портфоліо', pl: 'Zobacz Portfolio IT' },
    ...
    caps: {
      ...
      pl: ['Infrastruktura', 'Automatyzacja', 'Zgodność', 'Bezpieczeństwo', 'Monitoring', 'IAM'],
    },
  },

  // ─── ENTERPRISE OVERVIEW ────────────────────────────────────────────────────
  overview: {
    label: { de: 'Enterprise IT', en: 'Enterprise IT', fr: 'IT d\'Entreprise', uk: 'Enterprise IT', pl: 'Enterprise IT' },
    title: {
      ...
      pl: 'Sześć Domen. Jedna Odpowiedzialność.',
    },
    sub: {
      ...
      pl: 'Orkiestracja złożonych środowisk IT na wszystkich poziomach — od tożsamości po zarządzanie.',
    },
    domains: [
      {
        icon: 'cloud',
      ...
      {
        icon: 'zap',
        title: { de: 'Automation', en: 'Automation', fr: 'Automatisation', uk: 'Автоматизація', pl: 'Automatyzacja' },
        sub: { de: 'PowerShell · Python · Workflows', en: 'PowerShell · Python · Workflows', fr: 'PowerShell · Python · Workflows', uk: 'PowerShell · Python · Workflows', pl: 'PowerShell · Python · Workflows' },
        desc: {
          ...
          pl: 'Autorskie narzędzia automatyzacji — m.in. system routingu zgłoszeń w produkcji, skrypty migracyjne, procesy provisioningowe.',
        },
      },
      {
        icon: 'shield',
  ...
  systems: {
    label: { de: 'Architektur', en: 'Architecture', fr: 'Architecture', uk: 'Архітектура', pl: 'Architektura' },
    title: { de: 'Stack & Systemlandschaft', en: 'Stack & System Landscape', fr: 'Stack & Paysage Système', uk: 'Стек & Системний ландшафт', pl: 'Stos Technologiczny & Środowisko' },
    sub: {
  ...
  // ─── AUTOMATION & AGENTS ────────────────────────────────────────────────────
  automation: {
    label: { de: 'Automation', en: 'Automation', fr: 'Automatisation', uk: 'Автоматизація', pl: 'Automatyzacja' },
    title: { de: 'Orchestrierung & Automatisierung', en: 'Orchestration & Automation', fr: 'Orchestration & Automatisation', uk: 'Оркестрація & Автоматизація', pl: 'Orkiestracja & Automatyzacja' },
    sub: {
      ...
      pl: 'Systemy, które autonomicznie i bezbłędnie sterują procesami — a nie tylko wykonują skrypty.',
    },
    pipeline: [
      { num: '01', title: { de: 'Ereignis-Trigger', en: 'Event Trigger', fr: 'Déclencheur d\'Événement', uk: 'Тригер події', pl: 'Wyzwalacz Zdarzenia' }, desc: { de: 'Neue Tickets, AD-Änderungen, Alerts oder Zeitplan-Auslöser', en: 'New tickets, AD changes, alerts or scheduled triggers', fr: 'Nouveaux tickets, modifications AD, alertes ou planificateurs', uk: 'Нові тікети, зміни в AD, алерти або розклад', pl: 'Nowe zgłoszenia, zmiany w AD, alerty lub harmonogramy' }, status: 'done' },
      { num: '02', title: { de: 'Klassifikation', en: 'Classification', fr: 'Classification', uk: 'Класифікація', pl: 'Klasyfikacja' }, desc: { de: 'Regelbasierte Kategorisierung und Prioritätszuweisung', en: 'Rule-based categorization and priority assignment', fr: 'Catégorisation basée sur des règles et priorité', uk: 'Категоризація на основі правил і пріоритезація', pl: 'Kategoryzacja oparta na regułach i przypisywanie priorytetów' }, status: 'done' },
      { num: '03', title: { de: 'Routing & Zuweisung', en: 'Routing & Assignment', fr: 'Routage & Assignation', uk: 'Маршрутизація & Призначення', pl: 'Routing & Przypisanie' }, desc: { de: 'Automatische Zuweisung an den richtigen Bearbeiter (Ticket-Tool im Team-Einsatz)', en: 'Automatic assignment to the right agent (ticket tool used in production)', fr: 'Attribution automatique à l\'agent compétent (outil en production)', uk: 'Автоматичне призначення відповідального (інструмент у продакшні)', pl: 'Automatyczne przypisanie do odpowiedniego agenta (narzędzie w produkcji)' }, status: 'running', active: true },
      { num: '04', title: { de: 'Ausführung', en: 'Execution', fr: 'Exécution', uk: 'Виконання', pl: 'Wykonanie' }, desc: { de: 'PowerShell / Python / REST-API-Calls für Provisionierung, Migration oder Konfiguration', en: 'PowerShell / Python / REST API calls for provisioning, migration or configuration', fr: 'Appels PowerShell / Python / REST API pour provisioning ou migration', uk: 'PowerShell / Python / REST API для провіженінгу, міграції або налаштування', pl: 'PowerShell / Python / REST API do provisioningu, migracji lub konfiguracji' }, status: 'queued' },
      { num: '05', title: { de: 'Audit & Logging', en: 'Audit & Logging', fr: 'Audit & Journalisation', uk: 'Аудит & Логування', pl: 'Audyt & Logowanie' }, desc: { de: 'Nachvollziehbare Protokollierung aller Aktionen für Compliance und Review', en: 'Traceable logging of all actions for compliance and review', fr: 'Journalisation complète pour la conformité et les audits', uk: 'Прозоре документування всіх дій для комплаєнсу та аудиту', pl: 'Przejrzyste rejestrowanie wszystkich działań na potrzeby compliance i audytów' }, status: 'queued' },
    ],
    agents: [
      { icon: '⚡', name: { de: 'Ticket-Router', en: 'Ticket Router', fr: 'Routeur de Tickets', uk: 'Ticket Router', pl: 'Router Zgłoszeń' }, desc: { de: 'Regelbasierte Zuweisung für Support-Tickets im Team', en: 'Rule-based ticket assignment for support teams', fr: 'Attribution intelligente des tickets de support', uk: 'Маршрутизація тікетів підтримки на основі правил', pl: 'Automatyczne przypisywanie ticketów wsparcia w zespole' } },
      { icon: '🔐', name: { de: 'IAM-Provisioner', en: 'IAM Provisioner', fr: 'Provisionneur IAM', uk: 'IAM Provisioner', pl: 'IAM Provisioner' }, desc: { de: 'AD/Entra ID Benutzer-Lifecycle Automation', en: 'AD/Entra ID user lifecycle automation', fr: 'Automatisation du cycle de vie des comptes AD/Entra ID', uk: 'Автоматизація життєвого циклу користувачів AD/Entra ID', pl: 'Automatyzacja cyklu życia kont AD/Entra ID' } },
      { icon: '🔄', name: 'KKI Agent Framework', desc: { de: 'Wiederverwendbare Bausteine für Workflow-Automatisierung', en: 'Reusable building blocks for workflow automation', fr: 'Composants réutilisables pour l\'automatisation de workflows', uk: 'Багаторазові модулі для автоматизації робочих процесів', pl: 'Modułowe komponenty do automatyzacji procesów' } },
    ],
  },

  // ─── COMPLIANCE & GOVERNANCE ─────────────────────────────────────────────────
  compliance: {
    label: { de: 'Governance', en: 'Governance', fr: 'Gouvernance', uk: 'Governance', pl: 'Zarządzanie & Zgodność' },
    title: { de: 'Compliance & Betriebssicherheit', en: 'Compliance & Operational Security', fr: 'Conformité & Sécurité Opérationnelle', uk: 'Комплаєнс & Безпека операцій', pl: 'Compliance & Bezpieczeństwo Operacyjne' },
    sub: {
      ...
      pl: 'Środowiska regulowane wymagają bezwzględnej struktury i pełnej identyfikowalności.',
    },
    cards: [
      {
      ...
      {
        title: { de: 'Endpoint & Perimeter Security', en: 'Endpoint & Perimeter Security', fr: 'Sécurité Endpoints & Périmètre', uk: 'Безпека кінцевих пристроїв & Периметр', pl: 'Bezpieczeństwo Endpointów & Obwodu' },
        status: 'active',
  ...
  // ─── IMPACT / CASE STORIES ───────────────────────────────────────────────────
  impact: {
    label: { de: 'Impact', en: 'Impact', fr: 'Impact', uk: 'Результати', pl: 'Wpływ & Wyniki' },
    title: { de: 'Messbare Ergebnisse.', en: 'Measurable Results.', fr: 'Résultats Mesurables.', uk: 'Вимірні результати.', pl: 'Mierzalne Rezultaty.' },
    sub: {
      ...
      pl: 'Praktyczne kamienie milowe z 15 lat zarządzania systemami.',
    },
    cases: [
      {
        metric: '90k+',
        unit: '',
        title: { de: 'AD-Objekte administriert', en: 'AD Objects administered', fr: 'Objets AD administrés', uk: 'Об\'єктів AD під керуванням', pl: 'Zarządzane Obiekty AD' },
        desc: {
          ...
          pl: 'Ogólnokrajowe zarządzanie całą strukturą KRITIS AD w Johanniter Bundes-IT-Services — konta, grupy, zasady i uprawnienia.',
        },
        tag: { de: 'IAM · KRITIS · JoBITS', en: 'IAM · KRITIS · JoBITS', fr: 'IAM · KRITIS · JoBITS', uk: 'IAM · KRITIS · JoBITS', pl: 'IAM · KRITIS · JoBITS' },
      },
      {
        metric: '14',
        unit: { de: 'Jahre', en: 'Years', fr: 'Ans', uk: 'Років', pl: 'Lat' },
        title: { de: 'Produktivbetrieb-Erfahrung', en: 'Production Experience', fr: 'Expérience en Production', uk: 'Досвід у продакшні', pl: 'Doświadczenie w Produkcji' },
        desc: {
          ...
          pl: 'Ciągła eksploatacja infrastruktury IT w działalności handlowej BAUHAUS — od wsparcia L1 po optymalizację procesów.',
        },
        tag: { de: 'Operations · Tier 1–3', en: 'Operations · Tier 1–3', fr: 'Opérations · N1–N3', uk: 'Operations · Tier 1–3', pl: 'Operations · L1–L3' },
      },
      {
        metric: '0',
        unit: { de: 'Trial-&-Error', en: 'Trial & Error', fr: 'Tâtonnement', uk: 'Спроб і помилок', pl: 'Prób i Błędów' },
        title: { de: 'Strukturierte Diagnose', en: 'Structured Diagnostics', fr: 'Diagnostic Structuré', uk: 'Структурована діагностика', pl: 'Strukturalna Diagnostyka' },
        desc: {
          ...
          pl: 'Autorski standard KKEEY do powtarzalnej diagnostyki awarii. Własne narzędzie do routingu zgłoszeń w produkcji.',
        },
        tag: { de: 'Methodik · Automation', en: 'Methodology · Automation', fr: 'Méthodologie · Automatisation', uk: 'Методика · Автоматизація', pl: 'Metodologia · Automatyzacja' },
      },
    ],
  },
  ...
  // ─── BERUFSERFAHRUNG ────────────────────────────────────────────────────────
  career: {
    label: { de: 'Werdegang', en: 'Career', fr: 'Parcours', uk: 'Кар\'єра', pl: 'Kariera' },
    title: { de: 'Berufserfahrung', en: 'Work experience', fr: 'Expérience Professionnelle', uk: 'Досвід роботи', pl: 'Doświadczenie Zawodowe' },
    items: [
      {
  ...
  // ─── KERNKOMPETENZEN ────────────────────────────────────────────────────────
  skills: {
    label: { de: 'Kompetenzen', en: 'Skills', fr: 'Compétences', uk: 'Навички', pl: 'Kompetencje' },
    title: { de: 'Kernkompetenzen', en: 'Core competencies', fr: 'Compétences Clés', uk: 'Ключові компетенції', pl: 'Kluczowe Umiejętności' },
    groups: [
      {
      ...
      },
      {
        ...
        items: ['PowerShell', 'Python 3.12+', 'TypeScript', 'Docker & Cloud Run', { de: 'Prozessautomatisierung', en: 'Process automation', fr: 'Automatisation des processus', uk: 'Автоматизація процесів', pl: 'Automatyzacja procesów' }, { de: 'Eigene Workflow-Tools', en: 'Custom workflow tools', fr: 'Outils de workflow sur mesure', uk: 'Власні інструменти процесів', pl: 'Dedykowane narzędzia workflow' }],
      },
      {
      ...
      },
      {
        ...
        items: ['LiveKit 2.x Voice AI', 'Gemini API / Vertex AI', 'Local LLMs (LM Studio)', 'Rust / Tauri 2.0', 'Audio DSP & Metal GPU', { de: 'Agenten-Architekturen', en: 'Agentic Architectures', fr: 'Architectures d\'Agents', uk: 'Агентні архітектури', pl: 'Architektury Agentowe' }],
      },
    ],
  },
  ...
  tools: {
    label: { de: 'Proof of Work', en: 'Proof of Work', fr: 'Preuve de Réalisation', uk: 'Proof of Work', pl: 'Dowód Kompetencji' },
    title: { de: 'Eigene Tools & Methodik', en: 'Own tools & methodology', fr: 'Outils Personnalisés & Méthodologie', uk: 'Власні інструменти & Методологія', pl: 'Autorskie Narzędzia & Metodologia' },
    sub: {
      ...
      pl: 'Tam, gdzie widzę nieefektywność w operacjach, buduję rozwiązania — używane przez zespół w produkcji.',
    },
    items: [
      {
        name: { de: 'Ticket-Routing-Automatisierung', en: 'Ticket routing automation', fr: 'Automatisation du routage des tickets', uk: 'Автоматизація маршрутизації тікетів', pl: 'Automatyzacja Routingu Zgłoszeń' },
        sub: { de: '● Im Team-Einsatz · Eigenentwicklung', en: '● Used in production · Internal tool', fr: '● Déployé en équipe · Développement interne', uk: '● У командній роботі · Власна розробка', pl: '● Używane w produkcji · Rozwiązanie własne' },
        desc: {
          ...
          pl: 'Autorskie narzędzie przydzielające przychodzące zgłoszenia do właściwego specjalisty na podstawie reguł. Eliminuje codzienną manualną pracę triage.',
        },
      },
      {
        name: 'KKEEY-Standard',
        ...
        desc: {
          ...
          pl: 'Udokumentowana metodologia ustrukturyzowanej, powtarzalnej diagnostyki błędów — aby awarie były rozwiązywane w sposób identyfikowalny, a nie metodą prób i błędów.',
        },
      },
      {
        ...
        desc: {
          ...
          pl: 'Prywatnie opracowana struktura agentów z modułowymi komponentami do automatyzacji procesów — wspólny fundament moich autorskich narzędzi.',
        },
      },
    ],
  },
  ...
  // ─── NEBENPROJEKTE ──────────────────────────────────────────────────────────
  side: {
    label: { de: 'Zusatzqualifikation', en: 'Additional qualification', fr: 'Compétences Complémentaires', uk: 'Додаткова кваліфікація', pl: 'Dodatkowe Kwalifikacje' },
    title: { de: 'Nebenprojekte: KI-Entwicklung', en: 'Side projects: AI development', fr: 'Projets IA & Innovation', uk: 'Проєкти в сфері штучного інтелекту', pl: 'Projekty Poboczne: Rozwój AI' },
    text: {
  ...
  // ─── I18N STRINGS ────────────────────────────────────────────────────────────
  i18n: {
    navOverview:   { de: 'Überblick',     en: 'Overview',   fr: 'Aperçu',      uk: 'Огляд',       pl: 'Przegląd' },
    navSystems:    { de: 'Systeme',       en: 'Systems',    fr: 'Systèmes',    uk: 'Системи',     pl: 'Systemy' },
    navAutomation: { de: 'Automation',    en: 'Automation', fr: 'Automation',  uk: 'Автоматизація', pl: 'Automatyzacja' },
    navCareer:     { de: 'Werdegang',     en: 'Career',     fr: 'Parcours',    uk: 'Кар\'єра',    pl: 'Kariera' },
    navSkills:     { de: 'Skills',        en: 'Skills',     fr: 'Skills',      uk: 'Навички',     pl: 'Umiejętności' },
    navContact:    { de: 'Kontakt',       en: 'Contact',    fr: 'Contact',     uk: 'Контакти',    pl: 'Kontakt' },
    namePH:        { de: 'Ihr Name',      en: 'Your name',  fr: 'Votre nom',   uk: 'Ваше ім\'я',  pl: 'Twoje imię i nazwisko' },
    emailPH:       { de: 'Ihre E-Mail',   en: 'Your email', fr: 'Votre e-mail',uk: 'Ваш Email',   pl: 'Twój adres e-mail' },
    msgPH:         { de: 'Ihre Nachricht…', en: 'Your message…', fr: 'Votre message…', uk: 'Ваше повідомлення…', pl: 'Twoja wiadomość…' },
    ...
    downloadNote:  { de: 'Bewerbungsmappe: Anschreiben, Lebenslauf & Tech-Profil (PDF)', en: 'Application portfolio: cover letter, CV & tech profile (PDF)', fr: 'Dossier complet : lettre, CV et profil technique (PDF)', uk: 'Резюме та технічний профіль (PDF)', pl: 'Dokumenty aplikacyjne: list motywacyjny, CV i profil technologiczny (PDF)' },
    systemBadge:   { de: 'ORCHESTRATOR AKTIV', en: 'ORCHESTRATOR ACTIVE', fr: 'ORCHESTRATEUR ACTIF', uk: 'ОРКЕСТРАТОР АКТИВНИЙ', pl: 'ORKIESTRATOR AKTYWNY' },
  },
};
